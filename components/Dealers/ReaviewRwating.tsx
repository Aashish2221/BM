                  ...
                  ${
                    dealer.dealerReview.length < 2
                      ...
                      : 'max-h-[50rem] lg:h-auto'
                            ...
                            key={dealers.id}
              >
              <div className='mt-2 ml-4 flex items-center md:-mt-8 md:ml-7 md:flex lg:ml-10 lg:flex'>
                              ...
                              return (
                                <span key={index}>
                                  {dealers.rating >= index + 1 ||
                                    ...
                                    <TiStarFullOutline
                                      fill='#E49E2F'
                                      className='h-8 sm:mt-5 w-8 text-yellow-500 md:h-10 md:w-10 lg:h-10 lg:w-10'
                                    />
                                  ) : (
                                    <TiStarFullOutline
                                      fill='#C0C0C0'
