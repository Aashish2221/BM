...
export default function Blogs({
  ...
  const cardHeader=(blogs:any, alt:any)=>{
    return(
      <CardHeader
      floated={true}
              ...
              {blogs.map((blogs: any) => (
                ...
                >
                  <Link
                    ...
                    prefetch={false}
                  >
                   {cardHeader(blogs.image, blogs.title)}
...
export const CardFooters = (code:any) => {
  return (
...
export const cardHeader =(blogs:any)=>{
  return(
    <CardHeader
    floated={true}
    className='mx-1 -mt-16 h-40 shadow-none sm:mt-[-4rem] sm:h-44 md:-mt-20 md:h-48 lg:-mt-[65px] lg:h-52 xl:mx-2 xl:-mt-20'
