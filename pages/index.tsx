...
// -------------------------- Dynamic import -------------------//
const DescText = React.lazy(
  () => import('@/components/HomePageComponents/DescText')
);
const RequestProductModal = React.lazy(
      ...
      <Head>
        ...
        <script
         ...
         key='product-jsonld' />
          ...
          key='product-jsonld'
        />
        <link rel='preload' as='image' href={staticImage?
        <link
          rel='preload'
          as='image'
      ...
      <div className='mt-4 md:mt-2'>
        <div className='flex w-full items-center justify-center rounded text-2xl md:mt-0 lg:mt-0'>
          <Image
            ...
            loading='lazy'
            alt='ads'
            className='h-[300px] w-[445px] rounded-lg md:h-[250px] lg:w-[500px] xl:h-[300px] 2xl:h-[360px]'
          />
        </div>
      </div>
    </>
